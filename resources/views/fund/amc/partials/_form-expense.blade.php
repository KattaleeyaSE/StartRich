...
<div class="row">
	<div class="col-md-2">
		<div class="form-group{{ $errors->has('expenses.*.manager_fee') ? ' has-error' : '' }}">
		    ...
		    {!! Form::text('expenses[0][manager_fee]', null,['class' => 'form-control required', 'required' => 'required', 'pattern' => '^[0-9.]{1,}$']) !!}
	...
	<div class="col-md-2">
		<div class="form-group{{ $errors->has('expenses.*.actual_manager_fee') ? ' has-error' : '' }}">
		    ...
		    {!! Form::text('expenses[0][actual_manager_fee]', null,['class' => 'form-control required', 'required' => 'required', 'pattern' => '^[0-9.]{1,}$']) !!}
		    <div class="help-block with-errors"></div>
	...
	<div class="col-md-2">
		<div class="form-group{{ $errors->has('expenses.*.total_expense_ratio') ? ' has-error' : '' }}">
		    ...
		    {!! Form::text('expenses[0][total_expense_ratio]', null,['class' => 'form-control required', 'required' => 'required', 'pattern' => '^[0-9.]{1,}$']) !!}
		    <div class="help-block with-errors"></div>
	...
	<div class="col-md-2">
		<div class="form-group{{ $errors->has('expenses.*.trustee_fee') ? ' has-error' : '' }}">
		    ...
		    {!! Form::text('expenses[0][trustee_fee]', null,['class' => 'form-control required', 'required' => 'required', 'pattern' => '^[0-9.]{1,}$']) !!}
		    <div class="help-block with-errors"></div>
	...
	<div class="col-md-2">
		<div class="form-group{{ $errors->has('expenses.*.actual_trustee_fee') ? ' has-error' : '' }}">
		    ...
		    {!! Form::text('expenses[0][actual_trustee_fee]', null,['class' => 'form-control required', 'required' => 'required', 'pattern' => '^[0-9.]{1,}$']) !!}
		    <div class="help-block with-errors"></div>
	...
	<div class="col-md-2">
		<div class="form-group{{ $errors->has('expenses.*.registrar_fee') ? ' has-error' : '' }}">
		    ...
		    {!! Form::text('expenses[0][registrar_fee]', null,['class' => 'form-control required', 'required' => 'required', 'pattern' => '^[0-9.]{1,}$']) !!}
		    <div class="help-block with-errors"></div>
	...
	<div class="col-md-2">
		<div class="form-group{{ $errors->has('expenses.*.actual_registrar_fee') ? ' has-error' : '' }}">
		    ...
		    {!! Form::text('expenses[0][actual_registrar_fee]', null,['class' => 'form-control required', 'required' => 'required', 'pattern' => '^[0-9.]{1,}$']) !!}
		    <div class="help-block with-errors"></div>
	...
	<div class="col-md-2">
		<div class="form-group{{ $errors->has('expenses.*.other_fee') ? ' has-error' : '' }}">
		    ...
		    {!! Form::text('expenses[0][other_fee]', null,['class' => 'form-control required', 'required' => 'required', 'pattern' => '^[0-9.]{1,}$']) !!}
		    <div class="help-block with-errors"></div>
