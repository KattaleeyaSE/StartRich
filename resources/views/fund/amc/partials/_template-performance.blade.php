	...
	<div class="row">
		<div class="col-md-2">
			<div class="form-group{{ $errors->has('past_performances.*.name') ? ' has-error' : '' }}">
			    ...
			    {!! Form::text('past_performances[ROW_INDEX][name]', 'DEFAULT_ROW_NAME',['class' => 'form-control']) !!}
		...
		<div class="col-md-1">
			<div class="form-group{{ $errors->has('past_performances.*.3month') ? ' has-error' : '' }}">
			    ...
			    {!! Form::text('past_performances[ROW_INDEX][3month]', null,['class' => 'form-control']) !!}
		...
		<div class="col-md-1">
			<div class="form-group{{ $errors->has('past_performances.*.6month') ? ' has-error' : '' }}">
			    ...
			    {!! Form::text('past_performances[ROW_INDEX][6month]', null,['class' => 'form-control']) !!}
		...
		<div class="col-md-1">
			<div class="form-group{{ $errors->has('past_performances.*.1year') ? ' has-error' : '' }}">
			    ...
			    {!! Form::text('past_performances[ROW_INDEX][1year]', null,['class' => 'form-control']) !!}
		...
		<div class="col-md-1">
			<div class="form-group{{ $errors->has('past_performances.*.3year') ? ' has-error' : '' }}">
			    ...
			    {!! Form::text('past_performances[ROW_INDEX][3year]', null,['class' => 'form-control']) !!}
		...
		<div class="col-md-1">
			<div class="form-group{{ $errors->has('past_performances.*.5year') ? ' has-error' : '' }}">
			    ...
			    {!! Form::text('past_performances[ROW_INDEX][5year]', null,['class' => 'form-control']) !!}
		...
		<div class="col-md-1">
			<div class="form-group{{ $errors->has('past_performances.*.10year') ? ' has-error' : '' }}">
			    ...
			    {!! Form::text('past_performances[ROW_INDEX][10year]', null,['class' => 'form-control']) !!}
		...
		<div class="col-md-1">
			<div class="form-group{{ $errors->has('past_performances.*.since_inception') ? ' has-error' : '' }}">
			    ...
			    {!! Form::text('past_performances[ROW_INDEX][since_inception]', null,['class' => 'form-control']) !!}
