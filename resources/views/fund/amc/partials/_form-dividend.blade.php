<a class="btn btn-primary" id="btn-add-dividend"> + </a>
	...
	<div class="row">
		...
		<div class="form-group{{ $errors->has('dividends.*.payment_date') ? ' has-error' : '' }}">
		    {!! Form::label('dividends[0][payment_date]', 'payment_date *', ['class' => 'control-label col-md-3 col-sm-3 col-xs-12']) !!}
		    <div class="col-md-6 col-sm-6 col-xs-12">
		    {!! Form::text('dividends[0][payment_date]', null,['class' => 'form-control col-md-7 col-xs-12']) !!}
		    </div>
		...
		<div class="form-group{{ $errors->has('dividends.*.dividend_price') ? ' has-error' : '' }}">
		    {!! Form::label('dividends[0][dividend_price]', 'Company dividend_price *', ['class' => 'control-label col-md-3 col-sm-3 col-xs-12']) !!}
		    <div class="col-md-6 col-sm-6 col-xs-12">
		    {!! Form::text('dividends[0][dividend_price]', null,['class' => 'form-control col-md-7 col-xs-12']) !!}
		    </div>
