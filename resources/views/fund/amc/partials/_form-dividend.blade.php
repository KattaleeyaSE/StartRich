<a class="btn btn-primary" id="btn-add-dividend"> + </a>
	...
	<div class="row">
		...
		<div class="form-group{{ $errors->has('dividends.*.payment_date') ? ' has-error' : '' }}">
		    ...
		    {!! Form::date('dividends[0][payment_date]', null,['class' => 'form-control col-md-7 col-xs-12 required', 'required' => 'required']) !!}
		...
		<div class="form-group{{ $errors->has('dividends.*.dividend_price') ? ' has-error' : '' }}">
		    ...
		    <div class="col-md-6 col-sm-6 col-xs-12">
		    {!! Form::text('dividends[0][dividend_price]', null,['class' => 'form-control col-md-7 col-xs-12 required', 'required' => 'required', 'pattern' => '^[0-9.]{1,}$']) !!}
		    <div class="help-block with-errors"></div>
		    </div>
