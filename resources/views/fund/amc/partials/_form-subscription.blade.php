...
<div class="row">
	<div class="col-md-2">
		<div class="form-group{{ $errors->has('purchases.*.subscription_period') ? ' has-error' : '' }}">
		    ...
		    {!! Form::text('purchases[0][subscription_period]', null,['class' => 'form-control required', 'pattern' => '^[_A-z0-9 ]{1,}$']) !!}
	...
	<div class="col-md-2">
		<div class="form-group{{ $errors->has('purchases.*.min_first_purchase') ? ' has-error' : '' }}">
		    ...
		    {!! Form::text('purchases[0][min_first_purchase]', null,['class' => 'form-control required', 'pattern' => '^[_A-z0-9 ]{1,}$']) !!}
	...
	<div class="col-md-2">
		<div class="form-group{{ $errors->has('purchases.*.min_additional') ? ' has-error' : '' }}">
		    ...
		    {!! Form::text('purchases[0][min_additional]', null,['class' => 'form-control required', 'pattern' => '^[_A-z0-9 ]{1,}$']) !!}
	...
	<div class="col-md-2">
		<div class="form-group{{ $errors->has('purchases.*.redemtion_period') ? ' has-error' : '' }}">
		    ...
		    {!! Form::text('purchases[0][redemtion_period]', null,['class' => 'form-control required', 'pattern' => '^[_A-z0-9 ]{1,}$']) !!}
	...
	<div class="col-md-2">
		<div class="form-group{{ $errors->has('purchases.*.min_redemption') ? ' has-error' : '' }}">
		    ...
		    {!! Form::text('purchases[0][min_redemption]', null,['class' => 'form-control required', 'pattern' => '^[_A-z0-9 ]{1,}$']) !!}
	...
	<div class="col-md-2">
		<div class="form-group{{ $errors->has('purchases.*.min_balance') ? ' has-error' : '' }}">
		    ...
		    {!! Form::text('purchases[0][min_balance]', null,['class' => 'form-control required', 'pattern' => '^[_A-z0-9 ]{1,}$']) !!}
	...
	<div class="col-md-2">
		<div class="form-group{{ $errors->has('purchases.*.settlement_period') ? ' has-error' : '' }}">
		    ...
		    {!! Form::text('purchases[0][settlement_period]', null,['class' => 'form-control required', 'pattern' => '^[_A-z0-9 ]{1,}$']) !!}
...
<div class="row">
	<div class="col-md-2">
		<div class="form-group{{ $errors->has('expenses.*.manager_fee') ? ' has-error' : '' }}">
		    ...
		    {!! Form::text('expenses[0][manager_fee]', null,['class' => 'form-control required']) !!}
	...
	<div class="col-md-2">
		<div class="form-group{{ $errors->has('expenses.*.actual_manager_fee') ? ' has-error' : '' }}">
		    ...
		    {!! Form::text('expenses[0][actual_manager_fee]', null,['class' => 'form-control required']) !!}
	...
	<div class="col-md-2">
		<div class="form-group{{ $errors->has('expenses.*.total_expense_ratio') ? ' has-error' : '' }}">
		    ...
		    {!! Form::text('expenses[0][total_expense_ratio]', null,['class' => 'form-control required']) !!}
	...
	<div class="col-md-2">
		<div class="form-group{{ $errors->has('expenses.*.trustee_fee') ? ' has-error' : '' }}">
		    ...
		    {!! Form::text('expenses[0][trustee_fee]', null,['class' => 'form-control required']) !!}
	...
	<div class="col-md-2">
		<div class="form-group{{ $errors->has('expenses.*.actual_trustee_fee') ? ' has-error' : '' }}">
		    ...
		    {!! Form::text('expenses[0][actual_trustee_fee]', null,['class' => 'form-control required']) !!}
	...
	<div class="col-md-2">
		<div class="form-group{{ $errors->has('expenses.*.registrar_fee') ? ' has-error' : '' }}">
		    ...
		    {!! Form::text('expenses[0][registrar_fee]', null,['class' => 'form-control required']) !!}
	...
	<div class="col-md-2">
		<div class="form-group{{ $errors->has('expenses.*.actual_registrar_fee') ? ' has-error' : '' }}">
		    ...
		    {!! Form::text('expenses[0][actual_registrar_fee]', null,['class' => 'form-control required']) !!}
	...
	<div class="col-md-2">
		<div class="form-group{{ $errors->has('expenses.*.other_fee') ? ' has-error' : '' }}">
		    ...
		    {!! Form::text('expenses[0][other_fee]', null,['class' => 'form-control required']) !!}
