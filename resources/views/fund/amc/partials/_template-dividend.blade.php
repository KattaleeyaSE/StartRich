<div id="template-dividend" style="visibility: hidden;">
	...
	<div class="row">
		...
		<div class="form-group{{ $errors->has('dividends.*.payment_date') ? ' has-error' : '' }}">
		    ...
		    {!! Form::date('dividends[ROW_INDEX][payment_date]', null,['class' => 'form-control col-md-7 col-xs-12 required', 'required' => 'required']) !!}
		    </div>
		...
		<div class="form-group{{ $errors->has('dividends.*.dividend_price') ? ' has-error' : '' }}">
		    ...
		    <div class="col-md-6 col-sm-6 col-xs-12">
		    {!! Form::text('dividends[ROW_INDEX][dividend_price]', null,['class' => 'form-control col-md-7 col-xs-12 required', 'required' => 'required']) !!}
		    </div>
