<a class="btn btn-primary" id="btn-add-performance"> + </a>
		...
		<div class="form-group{{ $errors->has('performance_date') ? ' has-error' : '' }}">
			...
			{!! Form::date('performance_date', null, ['class' => 'form-control required', 'pattern' => '^[0-9.]{1,}$']) !!}
...
<div class="row">
	<div class="col-md-2">
		<div class="form-group{{ $errors->has('past_performances.*.name') ? ' has-error' : '' }}">
		    ...
		    {!! Form::text('past_performances[0][name]', null,['class' => 'form-control required', 'pattern' => '^[0-9.]{1,}$', 'id' => 'create-fund-return', 'readonly' => 'readonly']) !!}
		    <div class="help-block with-errors"></div>
	...
	<div class="col-md-1">
		<div class="form-group{{ $errors->has('past_performances.*.3month') ? ' has-error' : '' }}">
		    ...
		    {!! Form::text('past_performances[0][3month]', null,['class' => 'form-control required', 'pattern' => '^[0-9.]{1,}$']) !!}
		    <div class="help-block with-errors"></div>
	...
	<div class="col-md-1">
		<div class="form-group{{ $errors->has('past_performances.*.6month') ? ' has-error' : '' }}">
		    ...
		    {!! Form::text('past_performances[0][6month]', null,['class' => 'form-control required', 'pattern' => '^[0-9.]{1,}$']) !!}
		    <div class="help-block with-errors"></div>
	...
	<div class="col-md-1">
		<div class="form-group{{ $errors->has('past_performances.*.1year') ? ' has-error' : '' }}">
		    ...
		    {!! Form::text('past_performances[0][1year]', null,['class' => 'form-control required', 'pattern' => '^[0-9.]{1,}$']) !!}
		    <div class="help-block with-errors"></div>
	...
	<div class="col-md-1">
		<div class="form-group{{ $errors->has('past_performances.*.3year') ? ' has-error' : '' }}">
		    ...
		    {!! Form::text('past_performances[0][3year]', null,['class' => 'form-control required', 'pattern' => '^[0-9.]{1,}$']) !!}
		    <div class="help-block with-errors"></div>
	...
	<div class="col-md-1">
		<div class="form-group{{ $errors->has('past_performances.*.5year') ? ' has-error' : '' }}">
		    ...
		    {!! Form::text('past_performances[0][5year]', null,['class' => 'form-control required', 'pattern' => '^[0-9.]{1,}$']) !!}
		    <div class="help-block with-errors"></div>
	...
	<div class="col-md-1">
		<div class="form-group{{ $errors->has('past_performances.*.10year') ? ' has-error' : '' }}">
		    ...
		    {!! Form::text('past_performances[0][10year]', null,['class' => 'form-control required', 'pattern' => '^[0-9.]{1,}$']) !!}
		    <div class="help-block with-errors"></div>
	...
	<div class="col-md-1">
		<div class="form-group{{ $errors->has('past_performances.*.since_inception') ? ' has-error' : '' }}">
		    ...
		    {!! Form::text('past_performances[0][since_inception]', null,['class' => 'form-control required', 'pattern' => '^[0-9.]{1,}$']) !!}
		    <div class="help-block with-errors"></div>
...
<div class="row">
	<div class="col-md-2">
		<div class="form-group{{ $errors->has('past_performances.*.name') ? ' has-error' : '' }}">
		    ...
		    {!! Form::text('past_performances[3][name]', 'Benchmark 1',['class' => 'form-control required', 'pattern' => '^[0-9.]{1,}$', 'readonly' => 'readonly']) !!}
		    <div class="help-block with-errors"></div>
	...
	<div class="col-md-1">
		<div class="form-group{{ $errors->has('past_performances.*.3month') ? ' has-error' : '' }}">
		    ...
		    {!! Form::text('past_performances[3][3month]', null,['class' => 'form-control required', 'pattern' => '^[0-9.]{1,}$']) !!}
		    <div class="help-block with-errors"></div>
	...
	<div class="col-md-1">
		<div class="form-group{{ $errors->has('past_performances.*.6month') ? ' has-error' : '' }}">
		    ...
		    {!! Form::text('past_performances[3][6month]', null,['class' => 'form-control required', 'pattern' => '^[0-9.]{1,}$']) !!}
		    <div class="help-block with-errors"></div>
	...
	<div class="col-md-1">
		<div class="form-group{{ $errors->has('past_performances.*.1year') ? ' has-error' : '' }}">
		    ...
		    {!! Form::text('past_performances[3][1year]', null,['class' => 'form-control required', 'pattern' => '^[0-9.]{1,}$']) !!}
		    <div class="help-block with-errors"></div>
	...
	<div class="col-md-1">
		<div class="form-group{{ $errors->has('past_performances.*.3year') ? ' has-error' : '' }}">
		    ...
		    {!! Form::text('past_performances[3][3year]', null,['class' => 'form-control required', 'pattern' => '^[0-9.]{1,}$']) !!}
		    <div class="help-block with-errors"></div>
	...
	<div class="col-md-1">
		<div class="form-group{{ $errors->has('past_performances.*.5year') ? ' has-error' : '' }}">
		    ...
		    {!! Form::text('past_performances[3][5year]', null,['class' => 'form-control required', 'pattern' => '^[0-9.]{1,}$']) !!}
		    <div class="help-block with-errors"></div>
	...
	<div class="col-md-1">
		<div class="form-group{{ $errors->has('past_performances.*.10year') ? ' has-error' : '' }}">
		    ...
		    {!! Form::text('past_performances[3][10year]', null,['class' => 'form-control required', 'pattern' => '^[0-9.]{1,}$']) !!}
		    <div class="help-block with-errors"></div>
	...
	<div class="col-md-1">
		<div class="form-group{{ $errors->has('past_performances.*.since_inception') ? ' has-error' : '' }}">
		    ...
		    {!! Form::text('past_performances[3][since_inception]', null,['class' => 'form-control required', 'pattern' => '^[0-9.]{1,}$']) !!}
		    <div class="help-block with-errors"></div>
...
<div class="row">
	<div class="col-md-2">
		<div class="form-group{{ $errors->has('past_performances.*.name') ? ' has-error' : '' }}">
		    ...
		    {!! Form::text('past_performances[1][name]', 'Information Ratio',['class' => 'form-control required', 'pattern' => '^[0-9.]{1,}$', 'readonly' => 'readonly']) !!}
		    <div class="help-block with-errors"></div>
	...
	<div class="col-md-1">
		<div class="form-group{{ $errors->has('past_performances.*.3month') ? ' has-error' : '' }}">
		    ...
		    {!! Form::text('past_performances[1][3month]', null,['class' => 'form-control required', 'pattern' => '^[0-9.]{1,}$']) !!}
		    <div class="help-block with-errors"></div>
	...
	<div class="col-md-1">
		<div class="form-group{{ $errors->has('past_performances.*.6month') ? ' has-error' : '' }}">
		    ...
		    {!! Form::text('past_performances[1][6month]', null,['class' => 'form-control required', 'pattern' => '^[0-9.]{1,}$']) !!}
		    <div class="help-block with-errors"></div>
	...
	<div class="col-md-1">
		<div class="form-group{{ $errors->has('past_performances.*.1year') ? ' has-error' : '' }}">
		    ...
		    {!! Form::text('past_performances[1][1year]', null,['class' => 'form-control required', 'pattern' => '^[0-9.]{1,}$']) !!}
		    <div class="help-block with-errors"></div>
	...
	<div class="col-md-1">
		<div class="form-group{{ $errors->has('past_performances.*.3year') ? ' has-error' : '' }}">
		    ...
		    {!! Form::text('past_performances[1][3year]', null,['class' => 'form-control required', 'pattern' => '^[0-9.]{1,}$']) !!}
		    <div class="help-block with-errors"></div>
	...
	<div class="col-md-1">
		<div class="form-group{{ $errors->has('past_performances.*.5year') ? ' has-error' : '' }}">
		    ...
		    {!! Form::text('past_performances[1][5year]', null,['class' => 'form-control required', 'pattern' => '^[0-9.]{1,}$']) !!}
		    <div class="help-block with-errors"></div>
	...
	<div class="col-md-1">
		<div class="form-group{{ $errors->has('past_performances.*.10year') ? ' has-error' : '' }}">
		    ...
		    {!! Form::text('past_performances[1][10year]', null,['class' => 'form-control required', 'pattern' => '^[0-9.]{1,}$']) !!}
		    <div class="help-block with-errors"></div>
	...
	<div class="col-md-1">
		<div class="form-group{{ $errors->has('past_performances.*.since_inception') ? ' has-error' : '' }}">
		    ...
		    {!! Form::text('past_performances[1][since_inception]', null,['class' => 'form-control required', 'pattern' => '^[0-9.]{1,}$']) !!}
		    <div class="help-block with-errors"></div>
...
<div class="row">
	<div class="col-md-2">
		<div class="form-group{{ $errors->has('past_performances.*.name') ? ' has-error' : '' }}">
		    ...
		    {!! Form::text('past_performances[2][name]', 'Standard Deviation',['class' => 'form-control required', 'pattern' => '^[0-9.]{1,}$', 'readonly' => 'readonly']) !!}
		    <div class="help-block with-errors"></div>
	...
	<div class="col-md-1">
		<div class="form-group{{ $errors->has('past_performances.*.3month') ? ' has-error' : '' }}">
		    ...
		    {!! Form::text('past_performances[2][3month]', null,['class' => 'form-control required', 'pattern' => '^[0-9.]{1,}$']) !!}
		    <div class="help-block with-errors"></div>
	...
	<div class="col-md-1">
		<div class="form-group{{ $errors->has('past_performances.*.6month') ? ' has-error' : '' }}">
		    ...
		    {!! Form::text('past_performances[2][6month]', null,['class' => 'form-control required', 'pattern' => '^[0-9.]{1,}$']) !!}
		    <div class="help-block with-errors"></div>
	...
	<div class="col-md-1">
		<div class="form-group{{ $errors->has('past_performances.*.1year') ? ' has-error' : '' }}">
		    ...
		    {!! Form::text('past_performances[2][1year]', null,['class' => 'form-control required', 'pattern' => '^[0-9.]{1,}$']) !!}
		    <div class="help-block with-errors"></div>
	...
	<div class="col-md-1">
		<div class="form-group{{ $errors->has('past_performances.*.3year') ? ' has-error' : '' }}">
		    ...
		    {!! Form::text('past_performances[2][3year]', null,['class' => 'form-control required', 'pattern' => '^[0-9.]{1,}$']) !!}
		    <div class="help-block with-errors"></div>
	...
	<div class="col-md-1">
		<div class="form-group{{ $errors->has('past_performances.*.5year') ? ' has-error' : '' }}">
		    ...
		    {!! Form::text('past_performances[2][5year]', null,['class' => 'form-control required', 'pattern' => '^[0-9.]{1,}$']) !!}
		    <div class="help-block with-errors"></div>
	...
	<div class="col-md-1">
		<div class="form-group{{ $errors->has('past_performances.*.10year') ? ' has-error' : '' }}">
		    ...
		    {!! Form::text('past_performances[2][10year]', null,['class' => 'form-control required', 'pattern' => '^[0-9.]{1,}$']) !!}
		    <div class="help-block with-errors"></div>
	...
	<div class="col-md-1">
		<div class="form-group{{ $errors->has('past_performances.*.since_inception') ? ' has-error' : '' }}">
		    ...
		    {!! Form::text('past_performances[2][since_inception]', null,['class' => 'form-control required', 'pattern' => '^[0-9.]{1,}$']) !!}
		    <div class="help-block with-errors"></div>
