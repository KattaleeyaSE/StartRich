<a class="btn btn-primary" id="btn-add-manager"> + </a>
	...
	<div class="row">
		<div class="form-group{{ $errors->has('managers.*.name') ? ' has-error' : '' }}">
		    ...
		    {!! Form::text('managers[0][name]', null,['class' => 'form-control col-md-7 col-xs-12 required', 'maxlength' => '255', 'pattern' => '^[_A-z0-9]{1,}$']) !!}
		...
		<div class="form-group{{ $errors->has('managers.*.position') ? ' has-error' : '' }}">
		    ...
		    <div class="col-md-6 col-sm-6 col-xs-12">
		    {!! Form::text('managers[0][position]', null,['class' => 'form-control col-md-7 col-xs-12 required', 'maxlength' => '255', 'pattern' => '^[_A-z0-9]{1,}$']) !!}
		    <div class="help-block with-errors"></div>
		    </div>
		...
		<div class="form-group{{ $errors->has('managers.*.management_date') ? ' has-error' : '' }}">
		    ...
		    <div class="col-md-6 col-sm-6 col-xs-12">
		    {!! Form::date('managers[0][management_date]', null,['class' => 'form-control col-md-7 col-xs-12 required']) !!}
		    <div class="help-block with-errors"></div>
		    </div>
