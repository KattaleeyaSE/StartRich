...
<div class="form-group{{ $errors->has('code') ? ' has-error' : '' }}">
    ...
    <div class="col-md-6 col-sm-6 col-xs-12">
    {!! Form::text('code', null,['class' => 'form-control col-md-7 col-xs-12 required']) !!}
    </div>
        @if ($errors->has('code'))
            <span class="help-block">
...
<div class="form-group{{ $errors->has('management_company') ? ' has-error' : '' }}">
    ...
    <div class="col-md-6 col-sm-6 col-xs-12">
    {!! Form::text('management_company', null,['class' => 'form-control col-md-7 col-xs-12 required']) !!}
    </div>
...
<div class="form-group{{ $errors->has('trustee') ? ' has-error' : '' }}">
    ...
    <div class="col-md-6 col-sm-6 col-xs-12">
    {!! Form::text('trustee', null,['class' => 'form-control col-md-7 col-xs-12 required']) !!}
    </div>
...
<div class="form-group{{ $errors->has('frequency') ? ' has-error' : '' }}">
    ...
    <div class="col-md-6 col-sm-6 col-xs-12">
    {!! Form::text('frequency', null,['class' => 'form-control col-md-7 col-xs-12 required']) !!}
    </div>
...
<div class="form-group{{ $errors->has('approved_by') ? ' has-error' : '' }}">
    ...
    <div class="col-md-6 col-sm-6 col-xs-12">
    {!! Form::text('approved_by', null,['class' => 'form-control col-md-7 col-xs-12 required']) !!}
    </div>
...
<div class="form-group{{ $errors->has('supervision') ? ' has-error' : '' }}">
    ...
    <div class="col-md-6 col-sm-6 col-xs-12">
    {!! Form::text('supervision', null,['class' => 'form-control col-md-7 col-xs-12 required']) !!}
    </div>
...
<div class="form-group{{ $errors->has('name_of_guarantor') ? ' has-error' : '' }}">
    ...
    <div class="col-md-6 col-sm-6 col-xs-12">
    {!! Form::text('name_of_guarantor', null,['class' => 'form-control col-md-7 col-xs-12 required']) !!}
    </div>
...
<div class="form-group{{ $errors->has('net_asset_value') ? ' has-error' : '' }}">
    ...
    <div class="col-md-6 col-sm-6 col-xs-12">
    {!! Form::number('net_asset_value', null,['class' => 'form-control col-md-7 col-xs-12 required']) !!}
    </div>
