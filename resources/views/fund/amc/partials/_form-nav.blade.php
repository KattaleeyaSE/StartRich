	...
	<div class="row">
		<div class="col-md-2">
				<div class="form-group{{ $errors->has('navs.*.modified_date') ? ' has-error' : '' }}">
				    ...
				    {!! Form::date('navs[0][modified_date]', null,['class' => 'form-control required', 'required' => 'required']) !!}
		...
		<div class="col-md-1">
				<div class="form-group{{ $errors->has('navs.*.standard') ? ' has-error' : '' }}">
				    ...
				    {!! Form::text('navs[0][standard]', null,['class' => 'form-control required', 'required' => 'required', 'pattern' => '^[0-9.]{1,}$']) !!}
		    <div class="help-block with-errors"></div>
		...
		<div class="col-md-1">
				<div class="form-group{{ $errors->has('navs.*.bid') ? ' has-error' : '' }}">
				    ...
				    {!! Form::text('navs[0][bid]', null,['class' => 'form-control required', 'required' => 'required', 'pattern' => '^[0-9.]{1,}$']) !!}
		    <div class="help-block with-errors"></div>
		...
		<div class="col-md-1">
				<div class="form-group{{ $errors->has('navs.*.offer') ? ' has-error' : '' }}">
				    ...
				    {!! Form::text('navs[0][offer]', null,['class' => 'form-control required', 'required' => 'required', 'pattern' => '^[0-9.]{1,}$']) !!}
		    <div class="help-block with-errors"></div>
