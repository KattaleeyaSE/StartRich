<div id="template-fee" style="visibility: hidden;">
	<div class="row">
		<div class="col-md-2">
			...
			{!! Form::text('fees[ROW_INDEX][front_end_fee]', null, ['class' => 'form-control']) !!}
		</div>
		<div class="col-md-2">
			{!! Form::label('fees[ROW_INDEX][actual_front_end_fee]', 'actual_front_end_fee', ['class' => 'control-label']) !!}
			{!! Form::text('fees[ROW_INDEX][actual_front_end_fee]', null, ['class' => 'form-control']) !!}
		</div>
		<div class="col-md-2">
			{!! Form::label('fees[ROW_INDEX][back_end_fee]', 'back_end_fee', ['class' => 'control-label']) !!}
			{!! Form::text('fees[ROW_INDEX][back_end_fee]', null, ['class' => 'form-control']) !!}
		</div>
		<div class="col-md-2">
			{!! Form::label('fees[ROW_INDEX][actual_back_end_fee]', 'actual_back_end_fee', ['class' => 'control-label']) !!}
			{!! Form::text('fees[ROW_INDEX][actual_back_end_fee]', null, ['class' => 'form-control']) !!}
		</div>
		<div class="col-md-2">
			{!! Form::label('fees[ROW_INDEX][switching_fee]', 'switching_fee', ['class' => 'control-label']) !!}
			{!! Form::text('fees[ROW_INDEX][switching_fee]', null, ['class' => 'form-control']) !!}
		</div>
	</div>
</div>
