<div id="template-manager" style="visibility: hidden;">
	...
	<div class="row">
		<div class="form-group{{ $errors->has('managers.*.name') ? ' has-error' : '' }}">
		    ...
		    {!! Form::text('managers[ROW_INDEX][name]', null,['class' => 'form-control col-md-7 col-xs-12 required', 'required' => 'required', 'maxlength' => '255']) !!}
		...
		<div class="form-group{{ $errors->has('managers.*.position') ? ' has-error' : '' }}">
		    ...
		    <div class="col-md-6 col-sm-6 col-xs-12">
		    {!! Form::text('managers[ROW_INDEX][position]', null,['class' => 'form-control col-md-7 col-xs-12 required', 'required' => 'required', 'maxlength' => '255']) !!}
		    <div class="help-block with-errors"></div>
		    </div>
		...
		<div class="form-group{{ $errors->has('managers.*.management_date') ? ' has-error' : '' }}">
		    ...
		    <div class="col-md-6 col-sm-6 col-xs-12">
		    {!! Form::date('managers[ROW_INDEX][management_date]', null,['class' => 'form-control col-md-7 col-xs-12 required', 'required' => 'required']) !!}
		    </div>
