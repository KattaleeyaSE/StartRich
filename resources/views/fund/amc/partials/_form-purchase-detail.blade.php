...
<div class="row">
	<div class="col-md-2">
		<div class="form-group{{ $errors->has('purchases.*.subscription_period') ? ' has-error' : '' }}">
		    ...
		    {!! Form::text('purchases[0][subscription_period]', null,['class' => 'form-control required', 'maxlength' => '255']) !!}
	...
	<div class="col-md-2">
		<div class="form-group{{ $errors->has('purchases.*.min_first_purchase') ? ' has-error' : '' }}">
		    ...
		    {!! Form::text('purchases[0][min_first_purchase]', null,['class' => 'form-control required', 'maxlength' => '255']) !!}
		    <div class="help-block with-errors"></div>
	...
	<div class="col-md-2">
		<div class="form-group{{ $errors->has('purchases.*.min_additional') ? ' has-error' : '' }}">
		    ...
		    {!! Form::text('purchases[0][min_additional]', null,['class' => 'form-control required', 'maxlength' => '255']) !!}
		    <div class="help-block with-errors"></div>
	...
	<div class="col-md-2">
		<div class="form-group{{ $errors->has('purchases.*.redemtion_period') ? ' has-error' : '' }}">
		    ...
		    {!! Form::text('purchases[0][redemtion_period]', null,['class' => 'form-control required', 'maxlength' => '255']) !!}
		    <div class="help-block with-errors"></div>
	...
	<div class="col-md-2">
		<div class="form-group{{ $errors->has('purchases.*.min_redemption') ? ' has-error' : '' }}">
		    ...
		    {!! Form::text('purchases[0][min_redemption]', null,['class' => 'form-control required', 'maxlength' => '255']) !!}
		    <div class="help-block with-errors"></div>
	...
	<div class="col-md-2">
		<div class="form-group{{ $errors->has('purchases.*.min_balance') ? ' has-error' : '' }}">
		    ...
		    {!! Form::text('purchases[0][min_balance]', null,['class' => 'form-control required', 'maxlength' => '255']) !!}
		    <div class="help-block with-errors"></div>
	...
	<div class="col-md-2">
		<div class="form-group{{ $errors->has('purchases.*.settlement_period') ? ' has-error' : '' }}">
		    ...
		    {!! Form::text('purchases[0][settlement_period]', null,['class' => 'form-control required', 'maxlength' => '255']) !!}
		    <div class="help-block with-errors"></div>
