<div class="form-group{{ $errors->has('investment_asset_detail') ? ' has-error' : '' }}">
    ...
    {!! Form::text('investment_asset_detail', null,['class' => 'form-control col-md-7 col-xs-12']) !!}
    </div>
...
<div class="form-group{{ $errors->has('strategy_detail') ? ' has-error' : '' }}">
    ...
    <div class="col-md-6 col-sm-6 col-xs-12">
    {!! Form::text('strategy_detail', null,['class' => 'form-control col-md-7 col-xs-12']) !!}
    </div>
...
<div class="form-group{{ $errors->has('factor_impact') ? ' has-error' : '' }}">
    ...
    <div class="col-md-6 col-sm-6 col-xs-12">
    {!! Form::text('factor_impact', null,['class' => 'form-control col-md-7 col-xs-12']) !!}
    </div>
...
<div class="form-group{{ $errors->has('benchmark_detail') ? ' has-error' : '' }}">
    ...
    <div class="col-md-6 col-sm-6 col-xs-12">
    {!! Form::text('benchmark_detail', null,['class' => 'form-control col-md-7 col-xs-12']) !!}
    </div>
