...
<div class="form-group{{ $errors->has('firstname') ? ' has-error' : '' }}">
    ...
    <div class="col-md-6 col-sm-6 col-xs-12">
        <input type="text" name="firstname" value="{{isset($member) ? $member->firstname : old('firstname')}}" class="form-control col-md-7 col-xs-12" /> 
    </div>
...
<div class="form-group{{ $errors->has('lastname') ? ' has-error' : '' }}">
    ...
    <div class="col-md-6 col-sm-6 col-xs-12">
        <input type="text" name="lastname" value="{{isset($member) ? $member->lastname : old('lastname')}}" class="form-control col-md-7 col-xs-12" /> 
    </div>
...
<div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
    ...
    <div class="col-md-6 col-sm-6 col-xs-12">
        <input type="email" name="email" value="{{isset($member) ? $member->user->email : old('email')}}" class="form-control col-md-7 col-xs-12" /> 
    </div>
    @if ($errors->has('email'))
        <div class="row">
            <div class="col-md-12">
...
<div class="form-group{{ $errors->has('phone_number') ? ' has-error' : '' }}">
    ...
    <div class="col-md-6 col-sm-6 col-xs-12">
        <input type="text" name="phone_number" value="{{isset($member) ? $member->phone_number : old('phone_number')}}" class="form-control col-md-7 col-xs-12" /> 
    </div>
