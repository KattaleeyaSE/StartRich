<div class="form-group">
	...
	{!! Form::text('standard', null, ['class' => 'form-control required', 'required' => 'required', 'pattern' => '^[0-9.]{1,}$']) !!}
	<div class="help-block with-errors"></div>
</div>

<div class="form-group">
	{!! Form::label('bid', 'Bid', ['class' => 'control-label']) !!}
	{!! Form::text('bid', null, ['class' => 'form-control required', 'required' => 'required', 'pattern' => '^[0-9.]{1,}$']) !!}
	<div class="help-block with-errors"></div>
</div>

<div class="form-group">
	{!! Form::label('offer', 'Offer', ['class' => 'control-label']) !!}
	{!! Form::text('offer', null, ['class' => 'form-control required', 'required' => 'required', 'pattern' => '^[0-9.]{1,}$']) !!}
	<div class="help-block with-errors"></div>
</div>
