...
{
    function testGetRelationFundManagerFund_NotNull()
    {
        ...
        //Test  
        $result = $fundManager->fund->getAttributes(); 
        unset($result['updated_at']);
        unset($result['created_at']);
        $this->assertInstanceOf('\App\Models\MutualFund',$fundManager->fund);
      ...
      */
    public function testGetRelationFundManagerFund_Null()
    {
        //Set 
        $fundManager = FundManager::find(9999); 
        $fundManager->fund;
        //Test 
        $this->assertNull($fundManager);
    } 
}
