...
{
    function testGetRelationFeeFund_NotNull()
    {
        $fee = Fee::first(); 
        $expected = [ 
                'id' => 1,
        ...
        //Test  
        $result = $fee->fund->getAttributes(); 
        unset($result['updated_at']);
        unset($result['created_at']);
        $this->assertInstanceOf('\App\Models\MutualFund',$fee->fund);
      ...
      */
    public function testGetRelationFeeFund_Null()
    {
        //Set 
        $fee = Fee::find(9999); 
        $fee->fund;
